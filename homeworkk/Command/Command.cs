...
public class ExcelFile<T>
{
	...
	public string FileName 
		=> $"{Environment.GetFolderPath(Environment.SpecialFolder.Desktop)}/{typeof(T).Name}.xlsx";
...
public class PdfFile<T>
{
	...
	public string FileName 
		=> $"{Environment.GetFolderPath(Environment.SpecialFolder.Desktop)}/{typeof(T).Name}.pdf";
